...
- **Модели по умолчанию**: исполнитель — `gemini-3.1-pro` (в `agent --list-models` на VDS нет `gemini-2.5-*`; альтернатива Google в CLI — `gemini-3-flash`). Аудитор — `gemini-3.1-pro`. Env: `SHECTORY_EXECUTOR_AGENT_MODEL_ID`, `SHECTORY_AUDITOR_AGENT_MODEL_ID`; подписи в UI: `SHECTORY_EXECUTOR_MODEL_SPEC`, `SHECTORY_AUDITOR_MODEL_SPEC`.
