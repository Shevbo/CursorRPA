...
export const PORTAL_SETTINGS_REGISTRY: PortalSettingDef[] = [
  ...
  },
  {
    ...
    defaultValue: "Gemini 2.5 Pro (gemini-2.5-pro)",
    group: "ai",
  },
  {
  ...
  },
  {
    ...
    description: "Ключ для доступа к моделям OpenAI (GPT-4o и др.).",
    defaultValue: "",
    group: "secrets",
    isSecret: true,
  },
  {
    key: "MODEL_CLAUDE_API_KEY",
    label: "API-ключ Claude (Anthropic)",
    description: "Ключ для доступа к моделям Claude.",
    defaultValue: "",
    group: "secrets",
    isSecret: true,
  },
  {
    key: "MODEL_DEEPSEEK_API_KEY",
    label: "API-ключ DeepSeek",
    description: "Ключ для доступа к моделям DeepSeek.",
    defaultValue: "",
    group: "secrets",
    isSecret: true,
  },
  {
    key: "MODEL_OPENROUTER_API_KEY",
    label: "API-ключ OpenRouter",
    description: "Ключ для доступа к OpenRouter (единый доступ к разным моделям).",
    defaultValue: "",
    group: "secrets",
    isSecret: true,
  },
